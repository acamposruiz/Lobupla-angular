...
.factory('getVenues', function($http, $q) {
  ...
  var coordinatesFromAddress = function(address) {
  ...
  var venuesFromCoordinates = function(coordinates) {
    var deferred = $q.defer();
    $http({
  ...
  return{
    venuesFromAddress:function(address){
      return coordinatesFromAddress(address).then(venuesFromCoordinates);
    },
...
.controller('HomeCtrl', function ($scope, $cookies, $q, getVenues) {
  ...
  $scope.$root.venues = {
    search: function(address) {
      ...
      getVenues.venuesFromAddress(address)
